...
public class WebOrder {
    ...
    private List<WebOrdersQuantity> quantities = new ArrayList<>();
     ...
     */
    public List<WebOrdersQuantity> getQuantities() {
        return quantities;
    }
     ...
     */
    public void setQuantities(List<WebOrdersQuantity> quantities) {
